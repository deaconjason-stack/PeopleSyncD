...
internal sealed class RefreshSessionConfiguration : IEntityTypeConfiguration<RefreshSession>
{
    public void Configure(EntityTypeBuilder<RefreshSession> builder)
    {
        ...
        builder.Property(session => session.AssuranceLevel).HasMaxLength(32).IsRequired();
        builder.Property(session => session.AuthenticationMethod).HasMaxLength(32).IsRequired();
